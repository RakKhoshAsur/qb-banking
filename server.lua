...
RegisterServerEvent('ar-banking:server:SetBankClosed')
AddEventHandler('ar-banking:server:SetBankClosed', function(BankId, bool)
  print(BankId)
  BankStatus[BankId] = bool
  TriggerClientEvent('ar-banking:client:SetBankClosed', -1, BankId, bool)
end)
